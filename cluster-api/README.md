...
Addtionally, you will need to specify the cloud account name in your session by exporting it. By default this will be `openstack` as seen in the standard `clouds.yaml` file:

`export OS_CLOUD=<cloud-account-name>`
